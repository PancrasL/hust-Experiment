...
HD_PWD='E:/verilog/lpz_vivado/shiyan4/shiyan4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log auto_caculation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source auto_caculation.tcl
