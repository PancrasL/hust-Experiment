...
HD_PWD='E:/verilog/lpz_vivado/shiyan4/shiyan4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log auto_caculation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source auto_caculation.tcl -notrace
