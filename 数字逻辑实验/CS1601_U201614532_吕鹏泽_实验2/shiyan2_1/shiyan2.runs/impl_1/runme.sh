...
HD_PWD='E:/shu_zi_luo_ji/shiyan2_1/shiyan2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pipe3b_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pipe3b_top.tcl -notrace
