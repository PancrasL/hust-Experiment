...
HD_PWD='E:/shu_zi_luo_ji/shiyan2_2/shiyan2_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator_3_bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comparator_3_bit.tcl -notrace
